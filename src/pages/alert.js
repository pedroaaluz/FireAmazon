    ...
    const onShare = async () => {
        try {
            ...
            const result = await Share.share({
                ...
                message: "Um incêndio está ocorrendo na aldeia " + userInfo.name + ". Por favor, mande ajuda e não chegue perto das proximidades dessa aldeia, pois você pode correr perigo!"
            });
